...
INSERT INTO `tbl_acerca` VALUES (1,'Un titulo mas corto para el acerca de nosotros asi probamos ','																												Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus modi, ipsa ratione eius et placeat minus eos vel veritatis, temporibus, voluptates ducimus commodi doloremque adipisci dolor omnis rerum vero explicabo!	\r\n\r\nLorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus modi, ipsa ratione eius et placeat minus eos vel veritatis, temporibus, voluptates ducimus commodi doloremque adipisci dolor omnis rerum vero explicabo!																	','~fbb1d12c.jpg');
...
INSERT INTO `tbl_imagenes` VALUES (1,'thumb-1920-779395','59df5042','jpg','banner'),(2,'g1','0c038772','jpg','acerca'),(3,'p2','17bf949d','jpg','acerca'),(4,'t1','cfd29c08','jpg','acerca'),(5,'thumb-1920-779395','085eadfc','jpg','banner'),(6,'thumb-1920-779395','997b6d46','jpg','banner'),(7,'thumb-1920-696454','0a2c83f5','png','banner'),(8,'g9','99e1ba73','jpg','acerca'),(9,'g8','760ce4e6','jpg','acerca'),(10,'t2','666365ea','jpg','acerca'),(11,'t3','5e457b93','jpg','acerca'),(12,'te1','400bd2b0','jpg','acerca'),(13,'thumb-1920-779395','732240d9','jpg','banner'),(14,'thumb-1920-696454','1dabb74a','png','banner'),(15,'p1','bdb0c802','jpg','acerca'),(16,'p3','9202c305','jpg','acerca'),(17,'p2','fbb1d12c','jpg','acerca'),(18,'thumb-1920-779395','919a0f7d','jpg','banner');
...
CREATE TABLE `tbl_personal` (
  ...
  `tlf` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `id_estado` int(11) DEFAULT NULL,
  `id_ciudad` int(11) DEFAULT NULL,
  `id_municipio` int(11) DEFAULT NULL,
  `representante1` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tlf1` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `correo1` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cedula1` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `representante2` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tlf2` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `correo2` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cedula2` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
...
-- Dump completed on 2020-04-21 21:29:42
