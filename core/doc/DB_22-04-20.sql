...
INSERT INTO `tbl_perfil` VALUES (1,'admin'),(2,'tipo 1'),(3,'tipo 2'),(4,'tipo 3');
...
CREATE TABLE `tbl_personal_administrativo` (
  `id_personal_administrativo` int(50) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `apellido` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `direccion` text COLLATE utf8_spanish_ci,
  `genero` char(1) COLLATE utf8_spanish_ci DEFAULT NULL,
  `id_puesto` int(1) DEFAULT NULL,
  `cedula` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Dumping data for table `tbl_personal_administrativo`
--

LOCK TABLES `tbl_personal_administrativo` WRITE;
/*!40000 ALTER TABLE `tbl_personal_administrativo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_personal_administrativo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_puesto` VALUES (1,'profesor',1),(2,'integrante',1),(3,'tesorero',1),(4,'administrador',1),(5,'logistica',1);
...
-- Dump completed on 2020-04-22 21:03:06
